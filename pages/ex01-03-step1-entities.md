...
> 이 **엔티티 설계**가 클린 아키텍쳐에서 가장 고민해야할 부분이고, 또 중요한 부분이라고 생각합니다. 이것을 정하는 감각은 단번에 얻어지지 않는다고 생각합니다.. 저 역시 [객체지향의 사실과 오해](https://product.kyobobook.co.kr/detail/S000001628109)(조영호, 위키북스)를 참고하며 조금씩 이해를 높여가려고 노력 중입니다.
